  ...
  return (
    <div id='home' className='bg-black text-white text-center py-16'>
      ...
      <div className='mt-8 space-x-4'>
        ...
        transform transition-transform duration-300 hover:scale-105 px-4 py-2 rounded-full'><a href="https://drive.google.com/file/d/1iOem8XaWTyMNjXa8XF6eP7iOZV7xDIG2/view?usp=drive_link" target="_blank">Resume</a></button>
      </div>
    </div>
  )
}
